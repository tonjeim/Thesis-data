...
# Expression files
species1_expr_file <- "~/Data/HJUB_L_vst-normalized.tsv"
species2_expr_file <- "~/Data/HVUL_L_vst-normalized.tsv"

# Ortholog file
ortholog_group_file <- "~/HOG/Hordeum_jubatum__v__Hordeum_vulgare.tsv"

# Gene version patterns 
species1_gene_version_number <- NULL
...
comparison_table_name <- "hjub_hvul_l"
```
