---
title: "*B. distachyon - B. sylvaticum*"
author: Leaf samples
output:
  html_document:
    theme: yeti
...
# Expression files
species1_expr_file <- "~/Data/BDIS_L_vst-normalized.tsv"
species2_expr_file <- "~/Data/BSYL_L_vst-normalized.tsv"

# Ortholog file
ortholog_group_file <- "~/HOG/Brachypodium_distachyon__v__Brachypodium_sylvaticum.tsv"

# Gene version patterns 
species1_gene_version_number <- ".v3.2"
species2_gene_version_number <- ".v2.1"
ortholog_group_file_gene_version_numbers <- "\\.[0-9]{1,2}\\.[a-zA-Z]$|\\.[0-9]{1,2}$"

# Comparison table object name
comparison_table_name <- "bdis_bsyl_l"
```
